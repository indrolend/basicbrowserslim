...
export function createTransitionKernel({ transitionCanvas, heroContainer, spaRoot }) {
  ...
  function alignCanvas(fromSurface, toSurface) {
    ...
    const rootRect = (spaRoot || document.getElementById('spa-root')).getBoundingClientRect();
